    ...
    .controller('AdminEntityEditCtrl', ['$log', '$rootScope','$scope', '$http', '$sce', '$state', '$filter', 'entity', 'flash', 'EntityService', 'HostingOrganizationService', 'TaxonomyService', 'WillTypeService', 'places', 'testators', 'organizations', 'willTypes', function($log, $rootScope, $scope, $http, $sce, $state, $filter, entity, flash, EntityService, HostingOrganizationService, TaxonomyService, WillTypeService, places, testators, organizations, willTypes) {
        ...
        $scope.submit.action = function() {
            ...
            let formEntity = {
                ...
                will: {
                    title: "Testament "+$scope.entity.will.callNumber + ", minute du " + $scope.entity.will.minuteDateString + " - " + $filter('filter')($scope.testators, {id: parseInt($scope.entity.will.testator)}, true)[0].indexName,
                    ...
                    testator: $scope.entity.will.testator,
                    ...
                    pagePhysDescSupport: $scope.entity.will.pagePhysDescSupport,
                    pagePhysDescHeight: $scope.entity.will.pagePhysDescHeight,
                    pagePhysDescWidth: $scope.entity.will.pagePhysDescWidth,
                    pagePhysDescHand: $scope.entity.will.pagePhysDescHand,
                    pagePhysDescNumber: $scope.entity.will.pagePhysDescNumber,
                    envelopePhysDescSupport: $scope.entity.will.envelopePhysDescSupport,
                    envelopePhysDescHeight: $scope.entity.will.envelopePhysDescHeight,
                    envelopePhysDescWidth: $scope.entity.will.envelopePhysDescWidth,
                    envelopePhysDescHand: $scope.entity.will.envelopePhysDescHand,
