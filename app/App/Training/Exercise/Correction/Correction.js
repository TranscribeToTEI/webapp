...
angular.module('transcript.app.training.exercise.correction', ['ui.router'])

    .config(['$stateProvider', function($stateProvider) {
        $stateProvider.state('transcript.app.training.exercise.correction', {
            views: {
                "page" : {
                    templateUrl: 'App/Training/Exercise/Correction/Correction.html',
                    controller: 'AppTrainingExerciseCorrectionCtrl'
                },
                "comment@transcript.app.training.exercise.correction" : {
    ...
    .controller('AppTrainingExerciseCorrectionCtrl', ['$log', '$rootScope','$scope', '$http', '$sce', '$state', '$filter', 'trainingContent', 'trainingContents', 'UserPreferenceService', function($log, $rootScope, $scope, $http, $sce, $state, $filter, trainingContent, trainingContents, UserPreferenceService) {
